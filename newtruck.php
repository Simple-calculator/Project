...
<div class="container-fluid">
        <div class="row">
			...
			<div class="col-md-7 col-lg-7">
			  <div class="panel panel-primary">
			    <div class="panel-heading">
				  <h2>INSERT NEW TRUCK TO THE DATABASE<h2>
				</div>
				  <div class="panel-body">
				   <?php
					   ...
					   if (isset($_POST["submit"]) && isset($_POST["truckno"]) && isset($_POST["model"]) && isset($_POST["manuf"]) && isset($_POST["color"]) && isset($_POST["date2"]))
					   {
						 ...
						 $date2=$_POST['date2'];
						 echo "kihiko";
					    $sql="SELECT * FROM truck WHERE truckno='$truckno'";
						...
						$result="INSERT INTO  truck SET truckno='$truckno',model='$model',manufacture='$manuf',color='$color',date2='$date2'";
				     ...
				     <form class="form-horizontal" role="form" action="newtruck.php" method="POST"> 
					   ...
					   <div class="form-group">
						 ...
						 <div class="col-md-5"> 
						  <input class="form-control" required type="text" name="manuf"/>
						 </div> 
					   </div>
					   <div class="form-group">
