        ...
        <div class="row">
                     ...
                     <ul class="list-group">
						...
						<a href="javascript:;" data-toggle="collapse" data-target="#truck">Truck</a>
						  <ul  id="truck"class="collapse" >
						    ...
						    <li class="list-group-item"><a href="schedule">Schedule</a></li>
			    ...
			    <div class="panel-heading">
				  ...
				  <a  data-target="#myModal" data-toggle="modal" data-target="#myModal"  class="list-group btn btn-danger divider " >&nbsp;<span class="glyphicon glyphicon-remove"></span>Delete &nbsp;&nbsp;</a>
				   ...
				   <?php
					...
					$sql="SELECT * FROM driver,pictures ";
					...
					$contact=$row['contact'];
					 ...
					 echo "<tr>
					        <td><input type=\"checkbox\" name=\"selector\" id=\"optbox\" value=\"$driverid\"/></td>
					        <td>$fname</td>
					        <td>$lname</td>
					        <td>$email</td>
					        <td>$contact</td>
					        <td>$driverid</td>
					        <td><a href='img/$view'  target=\"_blank\" >view </a></td>
					        <td>$gender</td>
					        <td><a  type=\"button\" href=\"edit_opt.php ?id=$driverid   \" class=\"btn  btn-sm btn-success\"><span class=\"glyphicon glyphicon-pencil\"></span></a></td>
		  ...
		  if(isset($_POST['delete'])){
						...
						$id =$_POST['selector'];
							...
							$stmt="DELETE FROM driver WHERE driverid='".$id."'";
							
							
							//if($rslt){echo 'done';}else{echo'fail';}
							if(mysql_query($stmt)){echo "deleted";}else{echo "not deleted";}
