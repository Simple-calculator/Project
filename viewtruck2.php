        ...
        <div class="row">
				  ...
				  <a  data-target="#myModal" data-toggle="modal" data-target="#myModal"  class="list-group btn btn-danger divider " >&nbsp;<span class="glyphicon glyphicon-remove"></span>Delete &nbsp;&nbsp;</a>
				   ...
				   <?php
					...
					$manuf=$row['manufacture'];
					 ...
					 echo "<tr>
					        <td><input type=\"checkbox\" name=\"selector\" id=\"optbox\" value=\"$id\"/></td>
					        <td>$truckno</td>
					        <td>$model</td>
					        <td>$manuf</td>
					        <td>$color</td>
					        <td>$date</td>
					        <td><a  type=\"button\" href=\"edit_truck.php ?id=$id \" class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-pencil \"></span></a></td>
		  ...
		  if(isset($_POST['delete'])){
						...
						$id =$_POST['selector'];
							...
							$stmt="DELETE FROM truck WHERE truckno='$id'";
